...
# Freya v0.0.6.2 - WebSocket Route Configuration

**Commit:** 31a489d
**Date:** Server Architecture
**Description:** Server Architecture

## Overview

WebSocket route configuration and server architecture.
...
```bash
pip install freya-server
```

## Usage

```bash
freya-server --websocket
```
