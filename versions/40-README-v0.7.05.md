...
# Freya v0.7.05 - Enhanced BenchPage & BMAD v2.1

**Commit:** 815486f
**Date:** Advanced Benchmarking Features
**Description:** Advanced Benchmarking Features

## Overview

Enhanced BenchPage and BMAD v2.1 with advanced benchmarking features.
...
```bash
pip install freya-bench
```

## Usage

```bash
freya bench --advanced
```
