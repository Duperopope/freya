...
# Freya v0.9.03 - Story Generation Fixes

**Commit:** a27804f
**Date:** BMAD Content Generation
**Description:** BMAD Content Generation

## Overview

Story generation fixes for BMAD content generation.
...
```bash
pip install freya-story
```

## Usage

```bash
freya story --generate
```
